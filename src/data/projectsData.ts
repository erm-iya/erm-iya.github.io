...
export const projectsData: ProjectItem[] = [
  ...
  // ==========================================
  // 7. VahedManager (Academic & Algorithms)
  // ==========================================
  {
    id: 'vahed-manager',
    category: 'data',
    iconName: 'GraduationCap',
    metrics: '100% Conflict-Free Scheduling',
    tags: ['Node.js', 'Express', 'Interactive UI', 'Conflict Matrix', 'Session Auth'],
    githubUrl: 'https://github.com/erm-iya',
    title: {
      fa: 'سامانه هوشمند برنامه‌ریزی دروس و چیدمان ترم (VahedManager)',
      en: 'VahedManager Academic Timetable & Conflict Resolver',
      ku: 'سیستمی هۆشمەندی ڕێکخستنی وانەکانی زانکۆ (VahedManager)',
      de: 'VahedManager Akademischer Stundenplan- & Konfliktlöser',
    },
    summary: {
      fa: 'سامانه تحت وب مدیریت و چیدمان انتخاب واحد دانشگاهی با الگوریتم بررسی تداخل زمانی کلاس‌ها و امتحانات.',
      en: 'Web platform resolving university course schedule collisions, class overlaps, and exam calendar conflicts.',
      ku: 'پلاتفۆرمی وێب بۆ هەڵبژاردنی یەکەی وانەکان و بەرگری لە تێکچوونی کاتی پۆل و تاقیکردنەوە.',
      de: 'Webanwendung zur intelligenten Vermeidung von zeitlichen Überschneidungen bei Universitätskursen und Klausuren.',
    },
    description: {
      fa: 'پلتفرمی کاربردی برای دانشجویان و مدیران آموزش جهت شبیه‌سازی انتخاب واحد، جلوگیری از تداخل ساعت کلاس‌ها و روزهای امتحان پایانی، و طراحی هفتگی برنامه درسی در محیطی ساخت‌یافته و ساده.',
      en: 'Practical platform engineered for students and academic advisors to simulate course registrations, eliminate class schedule collisions, prevent exam date overlaps, and visualize weekly schedules seamlessly.',
      ku: 'بەرنامەیەکی بەسوود بۆ خوێندکاران و مامۆستایان تا بە بێ کێشە و تێکچوونی کاتی وانەکان، کاتی هەفتانەی خوێندن ڕێکبخەن.',
      de: 'Praktische Plattform für Studierende und Fakultäten zur Simulation von Kurswahlen, Vermeidung von Vorlesungsüberlappungen und visuellen Stundenplangestaltung.',
    },
    architecture: {
      fa: 'طراحی ماتریس اعتبارسنجی تداخل زمانی در سمت سرور با Node.js/Express، ساختار داده تفکیک‌شده برای دروس و اساتید، و سیستم احراز هویت سشن با دسترسی مجزای ادمین.',
      en: 'Server-side conflict matrix validation algorithms built with Node.js/Express, structured schema mapping course slots and prerequisites, and secure session-based admin controls.',
      ku: 'مەنتقی سێرڤەر بە Node.js بۆ دۆزینەوەی خێرای تێکچوونی کاتەکان و سیستمی سێشن بۆ چوونەژوورەوە.',
      de: 'Serverseitige Kollisionsprüfungsalgorithmen mit Node.js/Express, strukturierte Zuordnung von Modulen und Zeiten sowie sessionbasierte Authentifizierung.',
    },
    keyFeatures: {
      fa: [
        'تشخیص هوشمند و لحظه‌ای تداخل زمانی ساعت کلاس‌ها در طول هفته',
        'هشدار خودکار همزمانی تاریخ و ساعت امتحانات پایان‌ترم دروس انتخابی',
        'نمایش بصری جدول زمان‌بندی هفتگی و امکان پرینت برنامه نهایی',
        'پنل مدیریت برای تعریف، ویرایش و دسته‌بندی دروس و ظرفیت‌ها',
      ],
      en: [
        'Real-time automated conflict detection across weekly lecture timeslots',
        'Proactive overlap alerting for final examination dates and time slots',
        'Visual weekly timetable grid with instant schedule export capabilities',
        'Administrative dashboard for curriculum configuration, instructors, and capacities',
      ],
      ku: [
        'ناسینەوەی خێرای تێکچوونی کاتی وانەکان لە درێژایی هەفتەدا',
        'ئاگادارکردنەوە لە یەککەوتنی کاتی تاقیکردنەوەکانی کۆتایی',
        'خشتەی بینراوی هەفتانە بۆ ئاسانی سەیرکردنی وانەکان',
        'بەشی تایبەت بە بەڕێوەبەر بۆ زیادکردن و گۆڕینی وانەکان',
      ],
      de: [
        'Automatisierte Erkennung von Vorlesungsüberschneidungen im Wochenplan',
        'Frühzeitige Kollisionswarnung bei identischen Prüfungsterminen',
        'Visuelles Wochenstundenplan-Raster mit Exportfunktion',
        'Administrationsbereich zur Kurs- und Dozentenverwaltung',
      ],
    },
  },
