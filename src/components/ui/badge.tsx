...
function Badge({ className, variant = "default", ...props }: BadgeProps) {
  const variantStyles = {
    default: "border-transparent bg-teal-500/15 text-teal-300 border border-teal-500/30",
    secondary: "border-transparent bg-slate-800/80 text-slate-300 border border-white/5",
