...
export const ContactSection: React.FC<ContactSectionProps> = ({ currentLang }) => {
  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-8 relative">
      ...
      {/* Ambient Glow */}
      <div className="ambient-glow-teal top-1/2 -start-10 w-[450px] h-[450px] opacity-15"></div>
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-12 text-start">
          ...
          {/* Email Quick Card */}
          <div className="glass-card p-6 rounded-3xl border border-white/[0.07] hover:border-teal-500/30 transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 rounded-2xl bg-teal-500/10 border border-teal-500/20 text-teal-300 flex items-center justify-center">
              ...
              <Button
                ...
                size="sm"
                onClick={copyEmail}
                className="gap-1.5 text-xs text-slate-400 hover:text-teal-300"
              >
            ...
            <a
              href={`mailto:${email}`}
              className="text-sm font-mono text-slate-300 hover:text-teal-300 transition-colors"
            >
              {email}
            </a>
          </div>
          ...
          <div className="glass-card p-6 rounded-3xl border border-white/[0.07] hover:border-teal-500/30 transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              ...
              <a href="https://t.me/erm_iya_h" target="_blank" rel="noreferrer">
                <Button variant="ghost" size="sm" className="gap-1.5 text-xs text-slate-400 hover:text-sky-300">
                  <ExternalLink className="w-3.5 h-3.5" />
                  <span>{t.contact.telegramDirect}</span>
                </Button>
              </a>
            </div>
            <h3 className="text-base font-bold text-white mb-1">Telegram</h3>
            <a
              href="https://t.me/erm_iya_h"
              target="_blank"
              rel="noreferrer"
              className="text-sm font-mono text-slate-300 hover:text-sky-300 transition-colors"
            >
              @erm_iya_h
            </a>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 px-5 py-3 rounded-2xl glass-card text-xs sm:text-sm font-medium text-slate-300 hover:text-white hover:border-teal-500/40 transition-all"
          >
          ...
          <a
            href={`tel:${phone}`}
            className="flex items-center gap-2 px-5 py-3 rounded-2xl glass-card text-xs sm:text-sm font-medium text-slate-300 hover:text-emerald-300 hover:border-emerald-500/40 transition-all"
          >
