...
export const HeroSection: React.FC<HeroSectionProps> = ({ currentLang }) => {
  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col justify-center items-center pt-28 pb-16 px-4 sm:px-8 overflow-hidden">
      ...
      <div className="ambient-glow-teal top-16 -start-24 w-[420px] h-[420px] opacity-20"></div>
      <div className="ambient-glow-emerald bottom-10 -end-24 w-[460px] h-[460px] opacity-15"></div>
      ...
      <div className="max-w-4xl mx-auto w-full text-center relative z-10">
        ...
        <div className="inline-flex items-center justify-center mb-6">
          ...
          >
            ...
            <span className="text-teal-200">{t.hero.statusBadge}</span>
          </Badge>
        </div>
        ...
        <div className="relative inline-block mb-7 group">
          ...
          <div className="relative w-28 h-28 sm:w-36 sm:h-36 rounded-full overflow-hidden border-2 border-white/20 shadow-2xl bg-slate-900 mx-auto">
            <img
        ...
        <div className="space-y-2 mb-5">
          <h2 className="text-xs sm:text-sm font-semibold tracking-widest text-teal-400 uppercase">
            {t.hero.greeting}
          </h2>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3.5 mb-14">
          <a href="#projects">
            <Button size="lg" className="rounded-2xl gap-2 font-semibold bg-teal-600 hover:bg-teal-500 text-white shadow-lg shadow-teal-900/40">
          ...
          <div className="flex items-center gap-1.5 ps-2 border-s border-white/10">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-10 h-10 rounded-xl glass-card flex items-center justify-center text-slate-400 hover:text-white hover:border-teal-500/40 transition-all"
              title="GitHub"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-10 h-10 rounded-xl glass-card flex items-center justify-center text-slate-400 hover:text-teal-300 hover:border-teal-500/40 transition-all"
              title="Telegram"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-10 h-10 rounded-xl glass-card flex items-center justify-center text-slate-400 hover:text-emerald-300 hover:border-emerald-500/40 transition-all"
              title="LUXIMO"
            >
